//! Apache Avro schema provider implementation
...
/// Apache Avro schema provider
///
/// Generates Avro schema definitions
pub struct AvroProvider {
    spec_version: String,
}

impl AvroProvider {
    /// Creates a new Avro provider
...
mod tests {
    ...
    #[tokio::test]
    async fn test_avro_provider() {
        let provider = AvroProvider::default();
        let app = TestApp;
